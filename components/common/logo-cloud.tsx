    ...
    return (
        <section className="bg-background py-16">
            <div className="mx-auto max-w-5xl px-6">
                <h1 className="text-center text-lg font-medium">Backed By.</h1>
                <div className="mx-auto flex mt-10 max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
                    ...
                    <img className="h-5 w-fit" alt="Vercel OSS Program" src="https://vercel.com/oss/program-badge.svg" height="20" width="auto"/>
                </div>
            </div>
        </section>
    )
