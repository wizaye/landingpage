...
export function CleanCountdown({ className }: CleanCountdownProps) {
  ...
  return (
    <div className={cn("flex justify-center w-full scale-[.92] sm:scale-100", className)}>
      <div className="flex items-center gap-1.5 sm:gap-4 md:gap-6 lg:gap-8 w-full max-w-[18rem] sm:max-w-md md:max-w-lg lg:max-w-xl">
        <div className="flex flex-col items-center flex-1">
          <div className="relative w-full">
            <div className="bg-black/5 dark:bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-3 w-full flex items-center justify-center">
              <div className="text-base sm:text-2xl md:text-3xl lg:text-4xl font-mono font-bold text-foreground tabular-nums tracking-tight text-center">
        ...
        <div className="text-base sm:text-2xl md:text-3xl text-muted-foreground/30 font-mono">:</div>
